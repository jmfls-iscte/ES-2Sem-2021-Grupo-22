...
/**
 * 
 * this class reads an excel fileS
 *
 */
public class ExcelRead {
	...
	public void ChooseCell(Cell currentCell) {
		try {
			...
			case 0:
				...
				break;
			case 1:
				// criar ou verificar se existe package com o nome atual da c̩lula
			...
			case 2:
				// criar ou verificar se existe classe com o nome atual da c̩lula
			...
			case 3:
				// criar ou verificar se existe metodo com o nome atual da c̩lula
			...
			// Apanha a excesṣo das c̩lulas vazias
		}
	}
	...
	public Rule VerifyExistsCodeSmell(String name) {
		/*
		 * Verifica se existe alguma regra com o nome daquele code_smell Se ṇo existir
		 * ṇo l̻ do excel
		 */
		for (Rule r : rules) {
